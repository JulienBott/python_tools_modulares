...
class treeview_propio(gui_tkinter_widgets):
    ...
    def __init__(self, master, self_clase_gui_donde_call_rutina = None, **kwargs_config_widget):
        ...
        self.dicc_conversion_tipo_seleccion_item = {self.nombre_kwargs_dicc_treeview_seleccion_item_ninguno: "ninguno"
    ...
    def modificaciones(self, opcion: Literal["actualizar_desde_df", "modificar_objeto"], **kwargs):
        ...
        """
        Método que rellena el treeview con el dataframe pasado por parametro.

        args
        --
        --> actualizar_desde_df\n
        Permite reelenar el treeview usando un dataframe.
        ...
        --
        --> df_datos\n
        Se usa tan solo si se ha optado por la opción 'actualizar_desde_df'.

        --> kwargs_modificacion_treeview\n
        Se usa tan solo si se ha optado por la opción 'modificar_objeto'.
        """
