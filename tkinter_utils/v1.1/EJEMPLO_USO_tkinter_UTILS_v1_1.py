...
#importar el modulo
# --> el 1ero es OBLIGATORIO
# --> el 2ndo es para ejemplos de uso de rutinas / funciones en otros modulos
import tkinter_UTILS_v1_1 as mod_utils
import EJEMPLO_USO_tkinter_UTILS_v1_1_otros as mod_otros
...
class clase_ventana_inicio:
    ...
    def __init__(self, master):
        ...
        self.kwargs_config_boton_2 =  {"dicc_imagen": {"png_imagen": png_para_boton, "tupla_pixeles_imagen": (23, 23)}
        ...
        self.boton_1 = mod_utils.gui_tkinter_widgets(self.frame.widget_objeto, tipo_widget_param = "button", entorno_donde_se_llama_la_clase = self, **self.kwargs_config_boton_1)
        self.boton_2 = mod_utils.gui_tkinter_widgets(self.frame.widget_objeto, tipo_widget_param = "button", entorno_donde_se_llama_la_clase = self, **self.kwargs_config_boton_2)
...
kwargs_config_boton_2 =  {"width": 40
                        , "dicc_imagen": {"png_imagen": png_para_boton, "tupla_pixeles_imagen": (23, 23)}
                        , "dicc_colocacion": {"metodo": "place", "coord_x": 150, "coord_y": 48}
                        , "dicc_rutina":
                                        {"rutina": "def_rutina_boton_2"
...
boton_1 = mod_utils.gui_tkinter_widgets(frame.widget_objeto, tipo_widget_param = "button", entorno_donde_se_llama_la_clase = modulo_python_actual, **kwargs_config_boton_1)
boton_2 = mod_utils.gui_tkinter_widgets(frame.widget_objeto, tipo_widget_param = "button", entorno_donde_se_llama_la_clase = modulo_python_actual, **kwargs_config_boton_2)
...
##########################################################################################################
##########################################################################################################
# EJEMPLO 4 - boton con rutina en otro modulo
##########################################################################################################
##########################################################################################################
...
class clase_ventana_inicio:
    ...
    def __init__(self, master):
        ...
        self.frame = mod_utils.gui_tkinter_widgets(self.master.widget_objeto, tipo_widget_param = "frame", **self.kwargs_config_frame)
        self.boton = mod_utils.gui_tkinter_widgets(self.frame.widget_objeto, tipo_widget_param = "button", entorno_donde_se_llama_la_clase = self, **self.kwargs_config_boton)
        self.combobox = mod_utils.gui_tkinter_widgets(self.frame.widget_objeto, tipo_widget_param = "combobox", **self.kwargs_config_combobox)
...
combobox = mod_utils.gui_tkinter_widgets(frame.widget_objeto, tipo_widget_param = "combobox", **kwargs_config_combobox)
boton = mod_utils.gui_tkinter_widgets(frame.widget_objeto, tipo_widget_param = "button", entorno_donde_se_llama_la_clase = modulo_python_actual, **kwargs_config_boton)
...
##########################################################################################################
##########################################################################################################
# EJEMPLO 5 - frames scrollables dentro del root
##########################################################################################################
##########################################################################################################
...
class clase_ventana_inicio:
    ...
    def __init__(self, master):
        ...
        self.boton = mod_utils.gui_tkinter_widgets(self.master.widget_objeto, tipo_widget_param = "button", entorno_donde_se_llama_la_clase = self, **kwargs_config_boton)
...
boton = mod_utils.gui_tkinter_widgets(root.widget_objeto, tipo_widget_param = "button", entorno_donde_se_llama_la_clase = modulo_python_actual, **kwargs_config_boton)
...
png_messagebox_askokcancel = (os.path.join(sys._MEIPASS, "png_messagebox_askokcancel.png")
                                if getattr(sys, 'frozen', False)
                                else os.path.join(pathlib.Path(__file__).parent.absolute(), "png_messagebox_askokcancel.png"))
...
class clase_ventana_inicio:
    ...
    def def_rutina_boton(self, opcion_boton):
        ...
        if opcion_boton == "A":
            ...
            kwargs_messagebox = {"tipo_messagebox": "askyesnocancel"
                                , "iconbitmap": ico_tapar_pluma_tkinter
                                , "titulo": "titulo messagebox SIN imagen png"
                                , "mensaje": "Esto es una prueba."
                                , "bg_messagebox": "#A2CFE2"
                                , "fg_messagebox": "black"
                                , "bg_boton": "black"
                                , "fg_boton": "white"
                                }

            msg = mod_utils.messagebox_propio(self.master.widget_objeto, **kwargs_messagebox)

            print(msg.valor_boton_pulsado)
            ...
            kwargs_messagebox = {"tipo_messagebox": "askyesnocancel"
                                , "iconbitmap": ico_tapar_pluma_tkinter
                                , "titulo": "titulo messagebox CON imagen png"
                                , "mensaje": "Esto es una prueba."

                                , "dicc_imagen": {"png_imagen_messagebox": png_messagebox_askokcancel
                                                  , "tupla_pixeles_imagen": (40, 40)}
...
def def_rutina_boton(opcion_boton):
    ...
    if opcion_boton == "A":
        ...
        msg = mod_utils.messagebox_propio(root.widget_objeto, **kwargs_messagebox)
...
##########################################################################################################
##########################################################################################################
# EJEMPLO 8 - entry (con gui_tkinter_widgets)
##########################################################################################################
##########################################################################################################
...
##########################################################################################################
##########################################################################################################
# EJEMPLO 9 - entry (con entry_propio) con reglas validacion
##########################################################################################################
##########################################################################################################
...
class clase_ventana_inicio:
    ...
    def __init__(self, master):
        ...
        self.entry_validacion_personalizada = mod_utils.entry_propio(self.frame.widget_objeto, entorno_donde_se_llama_la_clase = self, **self.kwargs_config_entry_validacion_personalizada)
        self._entry_validacion_interna_y_personalizada = mod_utils.entry_propio(self.frame.widget_objeto, entorno_donde_se_llama_la_clase = self, **self.kwargs_config_entry_validacion_interna_y_personalizada)
...
entry_validacion_personalizada = mod_utils.entry_propio(frame.widget_objeto, entorno_donde_se_llama_la_clase = modulo_python_actual, **kwargs_config_entry_validacion_personalizada)
entry_validacion_interna_y_personalizada = mod_utils.entry_propio(frame.widget_objeto, entorno_donde_se_llama_la_clase = modulo_python_actual, **kwargs_config_entry_validacion_interna_y_personalizada)
...
##########################################################################################################
##########################################################################################################
# EJEMPLO 10 - entry fecha (con entry_propio) con calendario
##########################################################################################################
##########################################################################################################
...
class clase_de_mi_proyecto:
    ...
    def __init__(self, master):
        ...
        self.df_datos_1 = pd.DataFrame({"ID": [1, 2, 3, 4], "DESC": ["desc 1", "desc 2", "desc 3", "desc 4"]})

        self.df_datos_2 = pd.DataFrame({"ID": [1, 1, 1, 2, 2, 2], "CANTIDAD": [5, 8, 9, 4, 6, 8]})
        ...
        self.kwargs_config_treeview_1 = {"dicc_colocacion": {"metodo": "place", "coord_x": 20, "coord_y": 10}
                                        , "dicc_treeview": {"seleccion_item": "simple"
                                                            , "height": 4
                                                            ,"columnas_df": ["ID", "DESC"]
                                                            , "columnas_treeview": ["Id", "Desc"]
                                                            , "width_columnas_treeview": [50, 100]
                                                            }
                                        , "dicc_rutina_click_item": {"rutina": "def_rutina_click_item"}
                                        }
        
        self.kwargs_config_treeview_2 = {"dicc_colocacion": {"metodo": "place", "coord_x": 180, "coord_y": 10}
                                        , "dicc_treeview": {"seleccion_item": "multiple"
                                                            , "height": 4
                                                            ,"columnas_df": ["ID", "CANTIDAD"]
                                                            , "columnas_treeview": ["Id", "Cantidad"]
                                                            , "width_columnas_treeview": [50, 100]
                                                            }
                                        }

        self.kwargs_config_boton = {"text": "treeview 1"
                                    , "width": 10
                                    , "bg": "black"
                                    , "fg": "white"
        ...
        self.treeview_1 = mod_utils.treeview_propio(self.frame.widget_objeto, entorno_donde_se_llama_la_clase = self, **self.kwargs_config_treeview_1)
        self.treeview_2 = mod_utils.treeview_propio(self.frame.widget_objeto, entorno_donde_se_llama_la_clase = self, **self.kwargs_config_treeview_2)
    ...
    def def_rutina_click_item(self):
        ...
        datos_item_seleccionado_treeview_1 = self.treeview_1.datos_items
        print(datos_item_seleccionado_treeview_1)


        #se actualiza el treeview_2 segun el item seleccionado en el treeview_1
        #(dentro de la 1era sublista lista_datos_items_seleccionados se recupera el Id es decir el 1er item de la sublista)
        id_item_selecc_treeview_1 = int(datos_item_seleccionado_treeview_1["lista_datos_items_seleccionados"][0][0])
        df_datos_2_filtrado = self.df_datos_2.loc[self.df_datos_2["ID"] == id_item_selecc_treeview_1, ["ID", "CANTIDAD"]]
        self.treeview_2.acciones("actualizar_desde_df", df_datos = df_datos_2_filtrado)


        #se recupera del atributo datos_items del treeview_2 (dicc_registros_treeview_con_iid) los items que cumplen el requisito de cantidad >= 7
        #y se seleccionan en el treeview 2
        dicc_registros_treeview_con_iid_treeview_2 = self.treeview_2.datos_items["dicc_registros_treeview_con_iid"]
        lista_items_seleccionar_treeview_2 = [item_treeview for _, item_treeview in dicc_registros_treeview_con_iid_treeview_2.items() if item_treeview[1] >= 6]

        self.treeview_2.acciones("seleccionar_item", lista_item_seleccionado = lista_items_seleccionar_treeview_2)


    def def_rutina_boton(self):

        self.treeview_1.acciones("actualizar_desde_df", df_datos = self.df_datos_1)
...
df_datos_1 = pd.DataFrame({"ID": [1, 2, 3, 4], "DESC": ["desc 1", "desc 2", "desc 3", "desc 4"]})
df_datos_2 = pd.DataFrame({"ID": [1, 1, 1, 2, 2, 2], "CANTIDAD": [5, 8, 9, 4, 6, 8]})
...
kwargs_config_treeview_1 = {"dicc_colocacion": {"metodo": "place", "coord_x": 20, "coord_y": 10}
                                , "dicc_treeview": {"seleccion_item": "simple"
                                                    , "height": 4
                                                    ,"columnas_df": ["ID", "DESC"]
                                                    , "columnas_treeview": ["Id", "Desc"]
...
kwargs_config_treeview_2 = {"dicc_colocacion": {"metodo": "place", "coord_x": 180, "coord_y": 10}
                                , "dicc_treeview": {"seleccion_item": "multiple"
                                                    , "height": 4
                                                    ,"columnas_df": ["ID", "CANTIDAD"]
                                                    , "columnas_treeview": ["Id", "Cantidad"]
...
kwargs_config_boton = {"text": "treeview 1"
                            , "width": 10
                            , "bg": "black"
                            , "fg": "white"
                            , "dicc_colocacion": {"metodo": "place", "coord_x": 20, "coord_y": 140}
...
def def_rutina_click_item():
    ...
    datos_item_seleccionado_treeview_1 = treeview_1.datos_items
    print(datos_item_seleccionado_treeview_1)
    ...
    #(dentro de la 1era sublista lista_datos_items_seleccionados se recupera el Id es decir el 1er item de la sublista)
    id_item_selecc_treeview_1 = int(datos_item_seleccionado_treeview_1["lista_datos_items_seleccionados"][0][0])
    df_datos_2_filtrado = df_datos_2.loc[df_datos_2["ID"] == id_item_selecc_treeview_1, ["ID", "CANTIDAD"]]
    treeview_2.acciones("actualizar_desde_df", df_datos = df_datos_2_filtrado)


    #se recupera del atributo datos_items del treeview_2 (dicc_registros_treeview_con_iid) los items que cumplen el requisito de cantidad >= 7
    #y se seleccionan en el treeview 2
    dicc_registros_treeview_con_iid_treeview_2 = treeview_2.datos_items["dicc_registros_treeview_con_iid"]
    lista_items_seleccionar_treeview_2 = [item_treeview for _, item_treeview in dicc_registros_treeview_con_iid_treeview_2.items() if item_treeview[1] >= 6]

    treeview_2.acciones("seleccionar_item", lista_item_seleccionado = lista_items_seleccionar_treeview_2)


def def_rutina_boton():

    treeview_1.acciones("actualizar_desde_df", df_datos = df_datos_1)


treeview_1 = mod_utils.treeview_propio(frame.widget_objeto, entorno_donde_se_llama_la_clase = modulo_python_actual, **kwargs_config_treeview_1)
treeview_2 = mod_utils.treeview_propio(frame.widget_objeto, entorno_donde_se_llama_la_clase = modulo_python_actual, **kwargs_config_treeview_2)
...
##########################################################################################################
##########################################################################################################
# EJEMPLO 14 - nuevo root tras pulsar un botón (toplevel)
##########################################################################################################
##########################################################################################################
...
##########################################################################################################
##########################################################################################################
# EJEMPLO 15 - Aplicar a un widget varias rutinas de evento bind (ejemplo combobox)
##########################################################################################################
##########################################################################################################
...
class clase_de_mi_proyecto:
    ...
    def __init__(self, master):
        ...
        self.frame = mod_utils.gui_tkinter_widgets(self.master.widget_objeto, tipo_widget_param = "frame", **self.kwargs_config_frame)
        self.combobox = mod_utils.gui_tkinter_widgets(self.frame.widget_objeto, tipo_widget_param = "combobox", entorno_donde_se_llama_la_clase = self, **self.kwargs_config_combobox)
...
combobox = mod_utils.gui_tkinter_widgets(frame.widget_objeto, tipo_widget_param = "combobox", entorno_donde_se_llama_la_clase = modulo_python_actual, **kwargs_config_combobox)
...
##########################################################################################################
##########################################################################################################
# EJEMPLO 16 - Aplicar a una variable enlace (stringvar) varias rutinas de evento en modo trace
...
class clase_de_mi_proyecto:
    ...
    def __init__(self, master):
        ...
        self.frame = mod_utils.gui_tkinter_widgets(self.master.widget_objeto, tipo_widget_param = "frame", **self.kwargs_config_frame)
        self.combobox_1 = mod_utils.gui_tkinter_widgets(self.frame.widget_objeto, tipo_widget_param = "combobox", entorno_donde_se_llama_la_clase = self, **self.kwargs_config_combobox_1)
...
combobox_1 = mod_utils.gui_tkinter_widgets(frame.widget_objeto, tipo_widget_param = "combobox", entorno_donde_se_llama_la_clase = modulo_python_actual, **kwargs_config_combobox_1)
...
##########################################################################################################
##########################################################################################################
# EJEMPLO 17 - scrolledtext desde un string
##########################################################################################################
##########################################################################################################
...
##########################################################################################################
##########################################################################################################
# EJEMPLO 18 - scrolledtext desde un dataframe aplicando tags
##########################################################################################################
##########################################################################################################
...
##########################################################################################################
##########################################################################################################
# EJEMPLO 19 - Configuración de atributos nativos tkinter no integrados en mi_sistema_tkinter
